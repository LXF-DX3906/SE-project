<template>
  <div class="ac">
    ...
    <br>
    <h2 class="ac-title">密码</h2>
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
      <h5 class="ac-title">新密码</h5>
      <el-form-item prop="pass">
        <el-input
                v-model="ruleForm.pass" autocomplete="off" type="password"  placeholder="输入密码" class="ac-input">
        </el-input>
      </el-form-item>
      <h5 class="ac-title">确认密码</h5>
      ...
      <el-button class="ac-btn" @click="savepassword" :disabled="passwordbtn">确定</el-button>
    </el-form>
  </div>
</template>
